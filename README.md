...
Готово! Теперь твой проект полностью защищен лицензией GPLv3. Если нужно будет сделать то же самое для README основного проекта (Ikaros-Pocket) — просто скажи!# Automated WPA2 Handshake Cracking Script
