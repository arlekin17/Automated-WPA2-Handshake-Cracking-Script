Отлично! GPLv3 — это замечательный выбор. В отличие от MIT, лицензия GNU GPLv3 является «строгой» (copyleft): она гарантирует, что если кто-то возьмет твой код, изменит его и будет распространять, он **обязан** тоже открыть свой код под той же лицензией. Это отлично защищает open-source проекты.

Вот обновленная версия README на английском с лицензией **GNU GPLv3**:
